        ...
        if config_file.exists():
            try:
                ...
                if "hotkey" in filtered_data and isinstance(filtered_data["hotkey"], dict):
                    try:
                        filtered_data["hotkey"] = HotkeyConfig.model_validate(filtered_data["hotkey"])
                    except Exception:
        ...
        for field_name, field_info in cls.model_fields.items():
            if field_name in data:
                try:
                    ...
                    if field_name == "hotkey" and isinstance(data[field_name], HotkeyConfig):
                    ...
                    logger.warning(f"Invalid {field_name} {data[field_name]!r}, resetting to {default_val}")
