...
class TestEnhancement:
    def test_creation(self):
        enh = Enhancement(id="test_id", title="Test Enhancement", prompt="Fix the text")
    ...
    def test_from_dict(self):
        data = {"id": "test_id", "title": "Test Enhancement", "prompt": "Fix the text"}
...
class TestLLMProcessor:
    ...
    def test_process_calls_completion(self, mock_completion):
        ...
        processor = LLMProcessor(model="gpt-4o-mini", api_key="test-key")
        enhancement = Enhancement(id="test", title="Test", prompt="Fix the text")
